...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubCategory.img'
        db.add_column(u'apps_subcategory', 'img',
                      self.gf('django.db.models.fields.files.ImageField')(default=datetime.datetime(2013, 8, 6, 0, 0), max_length=100),
                      keep_default=False)

        # Adding field 'App.active'
        db.add_column(u'apps_app', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'CarouselApp.img'
        db.alter_column(u'apps_carouselapp', 'img', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'SubCategory.img'
        db.delete_column(u'apps_subcategory', 'img')

        # Deleting field 'App.active'
        db.delete_column(u'apps_app', 'active')


        # Changing field 'CarouselApp.img'
        db.alter_column(u'apps_carouselapp', 'img', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        u'apps.app': {
            ...
            'app_id': ('django.db.models.fields.CharField', [], {'default': "'ce95640c-fe75-11e2-9541-406c8f1fb6eb'", 'max_length': '36'}),
