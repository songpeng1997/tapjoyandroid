...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'App.app_type'
        db.add_column(u'apps_app', 'app_type',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'App.app_type'
        db.delete_column(u'apps_app', 'app_type')
    ...
    models = {
        u'apps.app': {
            ...
            'app_id': ('django.db.models.fields.CharField', [], {'default': "'af6649d7-fe9e-11e2-90cf-406c8f1fb6eb'", 'max_length': '36'}),
