...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CarouselApp'
        db.create_table(u'apps_carouselapp', (
        ...
        db.send_create_signal(u'apps', ['CarouselApp'])


    def backwards(self, orm):
        # Deleting model 'CarouselApp'
        db.delete_table(u'apps_carouselapp')
    ...
    models = {
        u'apps.app': {
            ...
            'app_id': ('django.db.models.fields.CharField', [], {'default': "'c49fb923-f200-11e2-b19a-406c8f1fb6eb'", 'max_length': '36'}),
