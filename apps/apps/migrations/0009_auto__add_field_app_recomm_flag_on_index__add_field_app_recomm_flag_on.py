...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'App.recomm_flag_on_index'
        db.add_column(u'apps_app', 'recomm_flag_on_index',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'App.recomm_flag_on_catg'
        db.add_column(u'apps_app', 'recomm_flag_on_catg',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'App.recomm_flag_on_index'
        db.delete_column(u'apps_app', 'recomm_flag_on_index')

        # Deleting field 'App.recomm_flag_on_catg'
        db.delete_column(u'apps_app', 'recomm_flag_on_catg')
    ...
    models = {
        u'apps.app': {
            ...
            'app_id': ('django.db.models.fields.CharField', [], {'default': "'d5ecacde-0e21-11e3-b8e5-406c8f1fb6eb'", 'max_length': '36'}),
